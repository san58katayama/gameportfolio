...
const translations = {
  ja: {
    ...
    hero_title:      "<span class='title-line'>発想力で世界を沸かす</span><br><span class='title-line'>ドキドキプランナー！</span>",
    hero_desc:       "ゲームの面白さを設計・言語化し、プレイヤーが思わず没頭してしまうような体験づくりに情熱を注いでいます。企画立案からレベルデザイン、仕様書作成まで、ゲームの「楽しさ」を追求します。",
    ...
    about_meta_birthday: "2007年3月14日 ホワイトデーだね(⋈◍＞◡＜◍)。✧♡",
    ...
    hobby1_tag:      "MAHJONG",
    hobby1_desc:     "頭脳戦と確率のゲーム！役づくりと押し引きの戦略を考えるのが大好きです。",
    hobby2_tag:      "MY CAT",
    hobby2_desc:     "癒しの相棒。お家でまったり過ごすときの最高のパートナーです。",
    hobby3_tag:      "RAMEN",
    hobby3_desc:     "濃厚な家系ラーメンが好物！美味しいお店の開拓が日課です。",
    hobby4_tag:      "GAME & GOODS",
    hobby4_desc:     "好きなゲーム作品のグッズやフィギュアをコレクションして楽しんでいます。",
  ...
  en: {
    ...
    about_meta_birthday: "Born on March 14, 2007 (White Day!) (⋈◍＞◡＜◍)。✧♡",
    ...
    skill_planning:  "Planning Ability",
    skill_level:     "Level Design",
    skill_spec:      "Spec Writing",
    skill_ppt:       "PowerPoint",
